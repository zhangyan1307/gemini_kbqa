...
public class CustomerKbQuestionController {
    ...
    public Response<CommonPageResponse<KbCustomerQuestionPageQueryResponse>> getQuestionList(KbCustomerQuestionPageQueryRequest request){
        return Response.ok(customerKbQuestionService
                .queryCustomerKbQuestionByPage(request));
    }

    @PostMapping("/saveQuestion")
    @ApiOperation("增加标准问答")
    public Response<Void> saveQuestion(KbCustomerQuestionAddRequest request){
        try {
    ...
    public Response<Void> deleteSimilarityQuestion(KbCustomerSimilarityDeleteRequest request){
        try {
            customerKbQuestionService.deleteSimilarityQuestion(
    ...
    public Response<Void> deleteRelationQuestion(KbCustomerRelationDeleteRequest request){
        try {
            customerKbQuestionService.deleteRelationQuestion(
                    request.getQuestionId());
            return Response.ok();
        }catch (Exception e){
            return Response.fail();
